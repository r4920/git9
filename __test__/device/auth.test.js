...
beforeAll(async function (){
  try {
    ...
    inserted_user = await user.insertOne({
      username: 'Sierra.OConner',
      password: 'kS6cXBJUa2xACfI',
      email: 'Mike43@hotmail.com',
      name: 'Yolanda Gleichner',
      mobileNo: '1-452-877-8261 x935',
      userType: 987,
      resetPasswordLink: {},
      loginRetryLimit: 103,
      loginReactiveTime: '2022-04-12T14:42:30.370Z',
      id: '622f0c5f2c4626561bc4aaf0'
    });
  }
  catch (err) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Stanford_Brekke',
        'password':'zm4qWx_P3qIm0f3',
        'email':'Ramona.McGlynn@gmail.com',
        'name':'Miss Ramon O\'Connell',
        'mobileNo':'(323) 923-4421 x732',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    ...
    let user = await request(app)
      .post('/device/auth/forgot-password')
      .send({ 'email':'Ramona.McGlynn@gmail.com', });
