...
beforeAll(async function (){
  try {
    ...
    inserted_user = await user.insertOne({
      username: 'Nash_Simonis',
      password: 'QhdTPXF7yZdV9pA',
      email: 'Vicenta21@hotmail.com',
      name: 'Craig Kertzmann',
      mobileNo: '(809) 457-8318 x7314',
      userType: 521,
      resetPasswordLink: {},
      loginRetryLimit: 181,
      loginReactiveTime: '2022-06-15T16:07:51.021Z',
      id: '622f0c5f2c4626561bc4aacc'
    });
  }
  catch (err) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Cicero60',
        'password':'lchzt2Ydp22MkFf',
        'email':'Adonis_Dach52@hotmail.com',
        'name':'Laurie Bergstrom',
        'mobileNo':'1-694-834-3131 x36068',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    ...
    let user = await request(app)
      .post('/admin/auth/forgot-password')
      .send({ 'email':'Adonis_Dach52@hotmail.com', });
